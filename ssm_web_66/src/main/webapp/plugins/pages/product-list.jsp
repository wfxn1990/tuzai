...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<div class="pull-left">
							<div class="form-group form-inline">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-default" title="导出Excel"
											onclick='export1()'><%----%>
										<i class="fa fa-file-o"></i> 导出Excel
	...
	<script type="text/javascript">
		...
		function gotoPage(num){
            ...
            ps = $("#pageSize").val();
			location.href="${pageContext.request.contextPath}/product/findAll?pageNum="+num+"&pageSize="+ps;
		}

        /**
		 * #pageSize: 获得select标签
		 * #pageSize  option: 获取的是所有的选项标签
		 * #pageSize option[value= ${pageInfo.pageSize }]:value=3 的选项
		 * prop： 设置selected属性属性值为 selected
         */
		$("#pageSize option[value=${pageInfo.pageSize}]" ).prop("selected","selected");
	</script>
	<script >
        function export1() {
          <%--/ $.get("${pageContext.request.contextPath}/product/proExport",function (data) {
                <%--alert(1)
				<%--if (data!=null) {
					<%--alert(1)
                }
            <%--})--%>
            location.href="${pageContext.request.contextPath}/product/proExport";
            <%--$.ajax({--%>
                <%--url : '${pageContext.request.contextPath}/product/proExport',--%>
                <%--data : data,--%>
                <%--dataType: 'json',--%>
                <%--type : 'get',--%>
                <%--xhrFields: {--%>
